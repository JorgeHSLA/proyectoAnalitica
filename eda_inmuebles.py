...
hist_vars = [
    "Valor_Arriendo_SM", "Area Construida", "Estrato", "num_farmacias_120m",
...
price_vars = [
    "Area Construida", "Estrato", "dist_via_principal_m", "num_farmacias_120m",
    "num_colegios_120m", "num_transmilenio_120m", "num_bus_120m", "num_universidades_300m"
]
...
for var in price_vars:
    ...
    if var == "Estrato":
        # Para Estrato, usar boxplot ya que es categórico
