...
# Ruta del nuevo CSV
csv_path = "c:/Users/Home/Desktop/proyectoAnalitica/datosDeMetroCuadrado.csv"

# Leer el archivo CSV
df = pd.read_csv(csv_path)

# Filtrar para Bogotá D.C. y Apartamento
df = df[df['mciudad'].str.contains('Bogotá D.C.', na=False)]
df = df[df['mtipoinmueble'].str.contains('Apartamento', na=False)]
...
# Guardar
output_path = "c:/Users/Home/Desktop/proyectoAnalitica/inmuebles_metrocuadrado_limpio.csv"
